...
<p align="center">
	<img src="https://raw.githubusercontent.com/oussamatght/oussamatght/main/pixel-banner.svg" alt="Animated pixel header" width="100%" />
</p>
...
```mermaid
flowchart LR
	User["User"] -->|WebSocket| WS[(Chat Gateway)]
	WS -->|broadcast| Clients["Other Clients"]
	User -->|REST| API[(REST API)]
	API --> DB[(Mongo/Postgres)]
	WS --> DB
```
